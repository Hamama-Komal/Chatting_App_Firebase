...
import com.example.chatapp.databinding.StatusItemsBinding;
...
public class TopStatusAdapter extends RecyclerView.Adapter<TopStatusAdapter.TopStatusViewHolder>{
    ...
    public TopStatusViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.status_items,parent,false);
    ...
    public class TopStatusViewHolder extends RecyclerView.ViewHolder {
        ...
        StatusItemsBinding binding;
        public TopStatusViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = StatusItemsBinding.bind(itemView);
        }
    }
}
